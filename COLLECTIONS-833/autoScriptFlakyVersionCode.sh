csv_file="test_results_COLLECTIONS-833_FlakyVersionCode.csv"
...
for ((i=1;i<=100;i++)); do
   ...
   mvn test -Dtest=org.apache.commons.collections4.properties.EmptyPropertiesTest#testStoreToOutputStream -Drat.skip=true | tee mvn-test-$i.log
   ...
   mkdir -p /Users/mderfan/FlakyTest/COLLECTIONS-833/FlakyVersionCode/isolation/$i
   mv mvn-test-$i.log /Users/mderfan/FlakyTest/COLLECTIONS-833/FlakyVersionCode/isolation/$i
 done
